...
//     const latLng = `${23.3441},${85.3096}`; // Coordinates for Ranchi (Example)
...
//             <Feather name="bookmark" size={24} color={COLORS.textMain} />
//           </TouchableOpacity>
//           <TouchableOpacity onPress={handleShare} style={styles.iconBtn}>
//             <Feather name="share-2" size={24} color={COLORS.textMain} />
//           </TouchableOpacity>
//         </View>
//       </View>
...
//                 {/* Action Buttons (Call / Direction) */}
//                 <View style={styles.actionRow}>
//                     <TouchableOpacity style={styles.circleBtn} onPress={handleCall}>
//                         <Feather name="phone" size={20} color={COLORS.primaryRed} />
//                     </TouchableOpacity>
//                     <TouchableOpacity style={[styles.circleBtn, {marginLeft: 16}]} onPress={handleDirections}>
//                         <Feather name="corner-up-right" size={20} color={COLORS.primaryRed} />
//                     </TouchableOpacity>
//                 </View>
//             </View>
...
//                     <Feather name="clock" size={18} color={COLORS.green} />
//                 </View>
//                 <View style={styles.infoContentCol}>
//                     <Text style={[styles.infoTitle, {color: COLORS.green}]}>
//                         Open now <Text style={{color: COLORS.textMain}}>• Closes 11:59 pm</Text>
//                     </Text>
//                 </View>
//                 <Feather name="chevron-down" size={20} color={COLORS.textSec} />
//             </TouchableOpacity>

//             <View style={styles.dottedDivider} />

//             {/* Info Row 2: Delivery Only */}
//             <TouchableOpacity style={styles.infoRow}>
//                 <View style={styles.infoIconCol}>
//                     <MaterialCommunityIcons name="moped-outline" size={20} color={COLORS.iconGrey} />
//                 </View>
//                 <View style={styles.infoContentCol}>
//                     <Text style={styles.infoTitle}>This is a delivery-only kitchen</Text>
//                     <Text style={styles.infoSub}>There are multiple brands delivering from this kitchen</Text>
//                 </View>
...
//             {/* Info Row 3: Plastic Free */}
//             <View style={styles.infoRow}>
//                  <View style={styles.infoIconCol}>
//                     <MaterialCommunityIcons name="bottle-soda-classic-outline" size={20} color={COLORS.iconGrey} />
//                 </View>
//                 <View style={styles.infoContentCol}>
//                     <Text style={styles.infoTitle}>Building a plastic-free future</Text>
...
//             {/* Info Row 4: Live since */}
//             <View style={styles.infoRow}>
//                  <View style={styles.infoIconCol}>
//                     <Feather name="smartphone" size={20} color={COLORS.iconGrey} />
//                 </View>
//                 <View style={styles.infoContentCol}>
//                     <Text style={styles.infoTitle}>Live on Zomato since 2025</Text>
//                 </View>
...
//         <View style={styles.card}>
//             <View style={styles.infoRow}>
//                  <Text style={styles.sectionHeader}>Had a bad experience here?</Text>
//             </View>
//             <TouchableOpacity style={styles.infoRow}>
//                 <View style={styles.infoIconCol}>
//                      <MaterialCommunityIcons name="eye-off-outline" size={20} color={COLORS.iconGrey} />
//                 </View>
//                 <View style={styles.infoContentCol}>
...
//                 Please review the terms of service for Zomato <Text style={{color: COLORS.primaryRed}}>here</Text>
//             </Text>
//         </View>
...
//       borderRadius: 22,
//       borderWidth: 1,
//       borderColor: '#FADADD', // Light red border
