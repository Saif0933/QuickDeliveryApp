...
// const HEADER_HEIGHT = 370; // Matches your heroContainer height
...
//   // 1. Header Opacity (Existing Logic)
//   const headerOpacity = scrollY.interpolate({
//     inputRange: [0, HEADER_HEIGHT - 100], // Show white header when scrolling near top
//     outputRange: [0, 1],
//     extrapolate: "clamp",
//   });

//   // 2. Parallax Translation (Image moves slower than scroll)
...
//   // 3. Zoom Scale (Image grows when pulling down)
...
//       {/* --- BACKGROUND ANIMATED HERO IMAGE (Moved Outside ScrollView) --- */}
//       <Animated.View
//         style={[
...
//       {/* --- Sticky Header (White Search Bar) --- */}
...
//         // Add Padding Top equal to Header Height so content starts below image
//         contentContainerStyle={{ paddingBottom: 100, paddingTop: HEADER_HEIGHT }} 
//       >
        
//         {/* CONTENT SHEET */}
//         {/* We keep marginTop -20 to pull the sheet slightly over the image */}
...
//   // --- Hero & Sheet (UPDATED FOR ANIMATION) ---
//   heroContainer: {
...
//       width: width,
//       zIndex: 0, // Behind the ScrollView
//       overflow: 'hidden', // Prevents image bleeding when zooming
//   },
//   heroImage: {
//       width: '100%',
//       height: '100%',
...
//       flexDirection: 'row',
//       alignItems: 'center',
//       backgroundColor: COLORS.highlight, // Dark green
//       paddingHorizontal: 8,
//       paddingVertical: 4,
//       borderRadius: 6,
//       marginBottom: 4,
...
const { width } = Dimensions.get("window");
// --- CHANGED: Increased height from 370 to 450 ---
...
const styles = StyleSheet.create({
  ...
  sheetHandle: {
      ...
      alignSelf: 'center',
      position: 'absolute',
      top: 10, // Places it nicely in the top padding area
  },
  resHeaderRow: {
      flexDirection: 'row',
      justifyContent: 'space-between',
