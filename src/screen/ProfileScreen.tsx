...
// const { width, height } = Dimensions.get('window'); // Get height for CSS fix
// const HEADER_HEIGHT = 320; // Slightly increased for better spacing
...
//   // 1. Header Translation (Parallax: Moves up at half speed)
...
//   // 2. Header Zoom (Scales up when pulling down)
...
//   // 3. Opacity for content inside header (Fades out as you scroll up)
...
//         ]}
//       >
//         {/* Profile Info inside the Animated Header */}
...
//                             Only show vegetarian options across the app.
//                         </Text>
...
//         onClose={() => setVegModeVisible(false)}
//       />
//     </View>
//   );
// };
...
//   root: {
//     flex: 1,
//     backgroundColor: COLORS.secondary, // Yellow background for top bounce effect
//   },
//   scrollView: { flex: 1, zIndex: 1 },

//   // --- HERO HEADER ANIMATION STYLES ---
//   heroContainer: {
//     position: 'absolute',
//     top: 0,
//     left: 0,
...
//     zIndex: 0,
//     overflow: 'hidden',
//     paddingTop: 30, // CSS Fix: Push content down slightly for status bar visual balance
//   },
...
//   // --- SHEET STYLES ---
//   sheet: {
//       backgroundColor: '#f5f7fa', // Grey background for content area
//       borderTopLeftRadius: 24,
//       borderTopRightRadius: 24,
//       marginTop: -24, // Overlap logic
//       paddingBottom: 40,
//       minHeight: height, // CSS Fix: Ensures sheet covers screen bottom
//       shadowColor: "#000",
...
//     left: 16,
//     zIndex: 100, // CSS Fix: Ensure it's always clickable
//     width: 40, height: 40,
//     backgroundColor: '#fff',
//     borderRadius: 20,
//     justifyContent: 'center', alignItems: 'center',
...
//       shadowRadius: 3,
//       elevation: 2,
//       overflow: 'hidden', // CSS Fix: Ensures rounded corners clip the list items
//   },
//   listItem: {
//       flexDirection: 'row',
//       alignItems: 'center',
      ...
      >
        ...
        <View style={styles.sheet}>
            ...
            <View style={styles.sectionContainer}>
                <Text style={styles.sectionHeader}>Other Information</Text>
                <View style={styles.listCard}>
                     <ListItem icon="share-variant-outline" label="Share the app" onPress={() => navigation.navigate('AccessibilitySettings')} />
