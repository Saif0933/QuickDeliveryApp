  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.paragraph}>
          Minta Restro is an online marketplace that facilitates the sale and delivery of fresh raw poultry, meat, and fish products.
        </Text>
        <Text style={styles.paragraph}>
          By placing an order through the Minta Restro mobile application, you agree to this Delivery, Cancellation, and Refund Policy.
        </Text>
        ...
        <Text style={styles.subSectionTitle}>1.1 Order Processing & Delivery Time</Text>
        <Text style={styles.bulletItem}>• Orders are generally processed within 60 minutes of confirmation.</Text>
        <Text style={styles.bulletItem}>• Delivery is typically completed within 60 minutes after dispatch, subject to location, traffic, weather conditions, and operational factors.</Text>
        <Text style={styles.bulletItem}>• Delivery timelines are estimates and may vary.</Text>

        <Text style={styles.subSectionTitle}>1.2 Delivery Charges</Text>
        <Text style={styles.bulletItem}>• Delivery fees (if applicable) are displayed clearly at checkout before payment confirmation.</Text>
        <Text style={styles.bulletItem}>• Charges may vary depending on distance, order value, or promotional offers.</Text>

        <Text style={styles.subSectionTitle}>1.3 Order Tracking</Text>
        <Text style={styles.paragraph}>Customers can track order status in real-time within the Minta Restro app.</Text>

        {/* Section 2: Nature of Products */}
        <Text style={styles.sectionTitle}>2. NATURE OF PRODUCTS</Text>
        <Text style={styles.paragraph}>
          Minta Restro supplies perishable food items (raw poultry, meat, and fish). Due to hygiene and food safety regulations:
        </Text>
        <Text style={styles.bulletItem}>• Products are non-returnable once delivered.</Text>
        <Text style={styles.bulletItem}>• We do not offer product replacements.</Text>
        <Text style={styles.bulletItem}>• Refunds are provided only in eligible cases described below.</Text>
        <Text style={styles.paragraph}>This policy complies with applicable food safety and consumer protection standards.</Text>

        {/* Section 3: Refund Eligibility */}
        <Text style={styles.sectionTitle}>3. REFUND ELIGIBILITY</Text>
        <Text style={styles.paragraph}>Refunds may be issued in the following circumstances, subject to verification:</Text>
        <Text style={styles.bulletItem}>1. Product delivered in damaged condition.</Text>
        <Text style={styles.bulletItem}>2. Product appears spoiled at the time of delivery.</Text>
        <Text style={styles.bulletItem}>3. Wrong product delivered.</Text>
        <Text style={styles.bulletItem}>4. Item(s) missing from the order.</Text>
        <Text style={styles.bulletItem}>5. Order marked as delivered but not received.</Text>
        <Text style={styles.paragraph}>All refund claims are subject to review and approval by Minta Restro.</Text>

        {/* Section 4: Time Limit */}
        <Text style={styles.sectionTitle}>4. TIME LIMIT FOR REPORTING ISSUES</Text>
        <Text style={styles.bulletItem}>• Customers must report delivery-related issues within 30 minutes of delivery confirmation.</Text>
        <Text style={styles.bulletItem}>• Reports can be submitted through in-app support or customer service.</Text>
        <Text style={styles.bulletItem}>• Claims submitted beyond this timeframe may not be eligible due to the perishable nature of food products.</Text>

        {/* Section 5: Required Proof */}
        <Text style={styles.sectionTitle}>5. REQUIRED PROOF</Text>
        <Text style={styles.paragraph}>To process a refund request, customers may be required to provide:</Text>
        <Text style={styles.bulletItem}>• Clear photos or video evidence</Text>
        <Text style={styles.bulletItem}>• Original packaging (if applicable)</Text>
        <Text style={styles.bulletItem}>• Order ID and relevant details</Text>
        <Text style={styles.paragraph}>Insufficient or unverifiable claims may result in denial of refund.</Text>

        {/* Section 6: Refund Processing */}
        <Text style={styles.sectionTitle}>6. REFUND PROCESSING</Text>
        <Text style={styles.bulletItem}>• Approved refunds are processed to the original payment method only.</Text>
        <Text style={styles.bulletItem}>• Refunds are typically credited within 5-10 business days, depending on the payment provider or bank.</Text>
        <Text style={styles.bulletItem}>• Minta Restro does not provide cash refunds for online payments.</Text>

        {/* Section 7: Cancellation Policy */}
        <Text style={styles.sectionTitle}>7. CANCELLATION POLICY</Text>
        <Text style={styles.subSectionTitle}>7.1 Cancellation Before Dispatch</Text>
        <Text style={styles.bulletItem}>• Orders may be cancelled within 30 minutes of placement, provided they have not been dispatched.</Text>
        <Text style={styles.bulletItem}>• Eligible cancellations will receive a full refund.</Text>
        
        <Text style={styles.subSectionTitle}>7.2 Cancellation After Dispatch</Text>
        <Text style={styles.bulletItem}>• Once an order is dispatched, cancellation may not be possible due to food safety and logistics constraints.</Text>
        <Text style={styles.bulletItem}>• In rare cases, cancellation approval remains at the discretion of Minta Restro.</Text>

        {/* Section 8: Misuse */}
        <Text style={styles.sectionTitle}>8. MISUSE & FRAUD PREVENTION</Text>
        <Text style={styles.paragraph}>Minta Restro reserves the right to:</Text>
        <Text style={styles.bulletItem}>• Reject refund requests that are fraudulent or abusive.</Text>
        <Text style={styles.bulletItem}>• Limit or suspend accounts involved in repeated false claims.</Text>
        <Text style={styles.paragraph}>Actions will be taken in accordance with applicable consumer protection laws.</Text>

        {/* Section 9: Customer Support */}
        <Text style={styles.sectionTitle}>9. CUSTOMER SUPPORT</Text>
        <Text style={styles.paragraph}>For assistance, customers may contact:</Text>
        <Text style={styles.bulletItem}>• Email: support@mintarestro.com</Text>
        <Text style={styles.bulletItem}>• In-App Support: Available within the Minta Restro App</Text>
