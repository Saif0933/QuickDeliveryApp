...
const SEARCH_HEIGHT = 70; // Increased slightly for better layout
        ...
        <View style={styles.heroContainer}>
          ...
          <View style={styles.searchWrapper}>
            <View style={styles.searchRow}>
              ...
              {/* MODIFIED: Toggle on Top, Text Below */}
...
const styles = StyleSheet.create({
  ...
  // --- UPDATED VEG MODE CSS ---
  vegModeContainer: { 
    flexDirection: 'column', // Changed to column to stack toggle and text
    alignItems: 'center', 
    justifyContent: 'center',
    width: 50,
  },
  vegTextColumn: { 
    alignItems: 'center',
    marginTop: -2, // Pull text closer to switch
  },
  vegModeLabel: {
    fontSize: 10,
    fontWeight: '900',
